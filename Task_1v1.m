...
CaseFile = "allcasesunzipped";
CaseNumber = "case_00071" ;  % Name des Cases (Unterordner)
filePath = fullfile(CaseFile, CaseNumber, "imaging.nii.gz");  % Pfad zur imaging-Datei
...
unten2D = squeeze(unten); 
seitlich2D = squeeze(seitlich);
frontal2D = squeeze(frontal);
